...
if __name__ == '__main__':
    ...
    for data in d:
        for link in ['Mean']:
            ...
            # input arguments
            parser = argparse.ArgumentParser(description='DMGIDDCVariants')
            parser.add_argument('--embedder', nargs='?', default='DMGIDDCVariants')
            ...
            parser.add_argument('--cls_reg', type=float, default=0.001, help='reg_coef')
            ...
            with open(filePath, 'a+') as f:
                ...
                print(args)
                from models import DMGIDDCVariants

                embedder = DMGIDDCVariants(args)
